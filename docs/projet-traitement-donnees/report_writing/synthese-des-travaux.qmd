...
```{r linearRegExplication, fig.align='center', out.width="\\textwidth", out.height="70%", fig.cap="Diagramme de flux des méthodes de la classe LinearRegression", echo=FALSE}
