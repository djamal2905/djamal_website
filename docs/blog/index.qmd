...
<div class="portfolio-shell">
  ...
  <div class="main-panel">
    ...
    <main id="main-content">
      ...
      <!-- ══ SECTION: Aperçus (curation manuelle) ════════════════════════ -->
      <p class="eyebrow" style="margin: 1.5rem 0 0.25rem 0.25rem;">Aperçus sélectionnés manuellement</p>

      <section class="section-card">
        <div class="section-header">
          <div>
            <h2 class="section-title">Articles disponibles</h2>
            <p class="section-lead">Tutoriels et notes déjà rédigés, mis en avant ici (chaque carte pointe vers l'article réel).</p>
          </div>
        </div>
      ...
      <p class="eyebrow" style="margin: 1.5rem 0 0.25rem 0.25rem;">Générée automatiquement</p>

      <section class="section-card">
        <div class="section-header">
          <div>
            <h2 class="section-title">Archive complète</h2>
            <p class="section-lead">Chaque article listé ici est déjà publié : dès qu'un fichier .qmd est déposé dans ce dossier, il apparaît automatiquement — il n'y a pas d'entrée "bientôt disponible" possible dans cette liste.</p>
          </div>
        </div>
```
