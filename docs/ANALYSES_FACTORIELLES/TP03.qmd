---
title: "Reprise du TP02 Méthodes d'Analyse factorielle"
date: "November, 2024"
author: "Djamal TOE"
---
...
Les données sont disponibles sur le site de mon professeur de méthodes d'analyse factorielle <<https://marieetienne.github.io/datasets/overshootday_overview.csv>>.
...
knitr::kable(eigen.values[1:3,1:3], caption = capTab("Valeurs propres et inerties expliquées par les 3 premiers axes"))
```
...
```{r, fig.align='center', fig.cap=capFig("Pourcentage d'inertie par dimension")}
...
```{r, fig.align='center', fig.cap=capFig("Comparaison des % d'inertie issues de l'ACP aevc et sans Singapore"), fig.width=11, fig.height=6}
...
```{r, fig.align='center', fig.cap=capFig("Affichage des pays sans Singapore"), fig.width=11, fig.height=6}
