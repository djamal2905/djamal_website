...
Je tiens tout d'abord à rapperler que je n'utilise pas de modèle **NLP** pour créer ce petit assistant virtuel. J'avais écris ce progamme en 2022, donc bien evidemment les outils utilisés ont évolué et donc vous pourrez l'ajuster à votre guise. Le code source sera téléchargeable à la fin de la page.
:::
