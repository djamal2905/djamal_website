      ...
      <section class="section-card">
        ...
        <div class="project-grid">
          <article class="project-card">
            ...
            <p class="project-description">Personal assistant split across two Raspberry Pi 4 (core/orchestration + vision &amp; security) with a local LLM and mobile/web/voice interfaces, reachable anywhere over Tailscale.</p>
          ...
          <article class="project-card">
            ...
            <p class="project-description">Submission and triage platform for scientific conferences: relevance scoring, duplicate detection, and post-deadline thematic clustering on a strictly layered FastAPI backend.</p>
