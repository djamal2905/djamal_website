    ...
    <main id="main-content">
      <section class="section-card">
        ...
        <div class="project-grid">
          ...
          <article class="project-card">
            <a class="project-thumb" href="content/machine-learning/breast-tumor-classification/Breast-Tumor-Article.html"><img src="images/thumbnails/breast-tumor-classification.jpg" alt="Mammography screening procedure, representing the breast tumor classification project" loading="lazy" /></a>
