...
<div class="portfolio-shell">
  <aside class="sidebar" aria-label="Profile sidebar">
    <div class="sidebar-card">
      ...
      <div class="sidebar-section"><h3>Contact</h3><ul class="contact-list"><li><strong>Email</strong><br />Available on request</li><li><strong>LinkedIn</strong><br /><a href="https://www.linkedin.com/in/djamal-toe-7a18432b0/">Profile</a></li></ul></div>
    </div>
  </aside>
  <div class="main-panel">
    <header class="topbar" aria-label="Top navigation"><button class="menu-toggle" id="menuToggle" aria-label="Open navigation drawer" aria-expanded="false"><i class="bi bi-list" aria-hidden="true"></i></button><a class="brand-pill" href="index.qmd" aria-label="Djamal TOE home"><img src="images/logo.png" alt="Djamal TOE logo" aria-hidden="true" /></a><nav class="nav-links" aria-label="Primary navigation"><a href="index.qmd">Home</a><a class="active" href="experience.qmd">Experience</a><a href="academic-projects.qmd">Academic</a><a href="personal-projects.qmd">Personal</a><a href="skills.qmd">Skills</a><a href="education.qmd">Education</a><a href="blog/index.qmd">Blog</a><a href="about.qmd">About</a></nav></header>
    <main id="main-content">
      ...
      <section class="section-card">
        <div class="section-header"><div><h2 class="section-title">Volunteering</h2><p class="section-lead">Volunteer contributions in health sciences, event logistics, and scientific communication.</p></div></div>
