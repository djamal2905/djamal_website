...
<div class="portfolio-shell">
  ...
  <div class="main-panel">
    ...
    <main id="main-content">
      ...
      <!-- ══ SECTION: Articles disponibles (mis en avant) ═══════════════ -->
      <section class="section-card">
        <div class="section-header">
          <div>
      ...
      <section class="section-card">
        <div class="section-header">
          <div>
            <h2 class="section-title">Tous les articles (auto-découverte)</h2>
            <p class="section-lead">Généré automatiquement à partir des fichiers .qmd de ce dossier.</p>
          </div>
        </div>
```
