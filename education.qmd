  ...
  <div class="main-panel">
    ...
    <main id="main-content">
      ...
      <section class="section-card">
        <div class="section-header"><div><h2 class="section-title">Certifications & Training</h2><p class="section-lead">Training and specialized courses that reinforce my data science, statistics, and AI skill set with visual certificates.</p></div></div>
        <div class="project-grid">
          <article class="project-card certification-card">
            <img class="project-thumb" src="certifs/Specialization_MAchine_Learning_stanford_deepLearning.png" alt="Stanford Machine Learning Specialization certificate" loading="lazy" />
          ...
          <article class="project-card certification-card">
            <img class="project-thumb" src="certifs/R_statistic_public_health_imperial_college_london.png" alt="Imperial College London R & Public Health certificate" loading="lazy" />
          ...
          <article class="project-card certification-card">
            <img class="project-thumb" src="certifs/python_meta.png" alt="Meta Python Programming certificate" loading="lazy" />
          ...
          <article class="project-card certification-card">
            <img class="project-thumb" src="certifs/excel_microsoft.png" alt="Microsoft Excel certification" loading="lazy" />
          ...
          <article class="project-card certification-card">
            <img class="project-thumb" src="certifs/bayesien.png" alt="Bayesian statistics certificate" loading="lazy" />
