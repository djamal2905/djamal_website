...
description: "Academic projects by Djamal TOE covering statistical foundations, survey methodology, public health statistics, machine learning, software engineering, computer vision, network science, and NLP."
format:
  html:
    toc: false
    css: styles.css
      ...
      <section class="section-card">
        ...
        <div class="project-grid">
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/nlp-scibert.jpg" alt="Doctor reading a medical journal, representing the biomedical text mining project" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/network-diffusion.png" alt="Social network analysis graph with highlighted central nodes, representing the coordinated behavior detection project" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/fueltrack.jpg" alt="Fuel pump at a gas station, representing the FuelTrack fuel-price application" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/nba-career-prediction.jpg" alt="Basketball player dunking during a game, representing the NBA career length prediction project" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/gaming-health.jpg" alt="Teenager playing video games with a controller, representing the gaming and adolescent health study" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/survey.jpg" alt="Person filling out a survey questionnaire on a clipboard, representing the practical survey project" loading="lazy" />
          ...
          <article class="project-card academic-box">
            <img class="project-thumb" src="images/thumbnails/hicp-forecast.jpg" alt="Rising financial trend chart, representing the consumer price index forecasting project" loading="lazy" />
    ...
    p2: {
      ...
      body: `
        ...
        <figure class="modal-figure">
          <img src="images/academic/poster-diffusion-inhauthentique.png" alt="Poster for the study of inauthentic image diffusion" loading="lazy" />
    ...
    p4: {
      ...
      body: `
        ...
        <div class="modal-links">
          <a class="btn-secondary" href="https://djamal2905.github.io/djamal_website/content/machine-learning/nba-career-prediction/report_writing/Presentation/presentation-ptd.html#/title-slide" target="_blank" rel="noopener noreferrer">Open slides</a>
        ...
        <figure class="modal-figure">
          <img src="content/machine-learning/nba-career-prediction/shiny_app_nba.png" alt="Preview of the NBA Shiny application" loading="lazy" />
