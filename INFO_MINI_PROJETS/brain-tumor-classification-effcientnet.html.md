...
::: {.cell-output-display}
![Echantillons des images de la méningiome collectées](data_brain_tumor/menin.png){#fig-menin fig-align='center' width=90% height=80%}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Echantillons des images de la gliome collectées](data_brain_tumor/gioma.png){#fig-giom fig-align='center' width=90% height=80%}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Echantillons des images des autres types de tumeurs collectées](data_brain_tumor/tumor.png){#fig-tm fig-align='center' width=90% height=80%}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Évolution de l'exactitude et de la perte pendant l'entraînement](data_brain_tumor/validation_train_metrics.png){#fig-evolution-training-validation fig-align='center' width=90% height=80%}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Matrice de confusion](data_brain_tumor/cm.png){#fig-cm fig-align='center' width=90% height=80%}
:::
:::
...
::: {#tbl-metrics-simple .cell tbl-cap='Métriques en pourentage par classe'}
::: {.cell-output-display}
`````{=html}
<table>
<caption>Scores par classe en pourcentage</caption>
 <thead>
  <tr>
...
::: {#tbl-metrics-globale .cell tbl-cap='Métriques globales en pourentage'}
::: {.cell-output-display}
`````{=html}
<table>
<caption>Scores globaux en pourcentage</caption>
 <thead>
  <tr>
